        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div class="max-w-xl">
                        <form method="POST" action="{{ route('admin.students.import') }}" class="space-y-4" enctype="multipart/form-data">
                            @csrf
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Chọn file CSV hoặc Excel</label>
                            ...
                            <div class="bg-blue-50 border border-blue-200 rounded-md p-4">
                                ...
                                <div class="bg-white p-2 rounded text-xs font-mono">email,name,is_active,access_starts_at,access_ends_at</div>
