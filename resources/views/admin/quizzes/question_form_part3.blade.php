    ...
    <div class="container mx-auto px-4 py-8">
        <div class="max-w-5xl mx-auto bg-white rounded-2xl shadow-lg border border-slate-200 p-8">
            <h1 class="text-2xl font-bold mb-6 flex items-center gap-2">
                {{ isset($question->id) ? 'Sửa' : 'Tạo' }} Reading Part 3 — Matching
            ...
            <form method="POST"
                ...
                {{-- ITEMS: CỐ ĐỊNH 4 (A–D) --}}
                <div class="mb-8">
                    <label class="block text-base font-semibold text-slate-700 mb-2">Các đoạn văn (items) — 4 đoạn (A–D)
                ...
                {{-- OPTIONS: CỐ ĐỊNH 7 --}}
                <div class="mb-8">
                    <label class="block text-base font-semibold text-slate-700 mb-2">Các lựa chọn (options) — 7 lựa chọn
                        <span class="text-red-500">*</span></label>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        @for($i = 0; $i < 7; $i++)
                            <div class="flex items-center gap-2 mb-2">
                                ...
                                <input type="text" name="options[{{ $i }}]"
                                    class="flex-1 rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm text-slate-800 shadow-sm outline-none transition focus:border-blue-500 focus:ring-2 focus:ring-blue-500/40 option-text"
                ...
                <div class="mb-8">
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full border border-slate-200 rounded-xl bg-gray-50">
                            <thead>
                                <tr>
                ...
                <div class="flex justify-end mt-6 gap-4">
                    <a href="{{ route('admin.quizzes.questions') }}"
                        class="inline-flex items-center px-5 py-2 bg-white border border-slate-300 rounded-xl font-semibold text-sm text-blue-700 shadow hover:bg-blue-50 focus:outline-none focus:ring-2 focus:ring-blue-500/60 transition">
                        Quay lại
                    </a>
                    <button type="submit"
                        class="inline-flex items-center px-5 py-2 bg-blue-600 border border-transparent rounded-xl font-semibold text-sm text-white shadow hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500/60 transition">
