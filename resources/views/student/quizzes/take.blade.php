<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900" x-data="readingQuiz">
                    {{-- Header with Timer --}}
                    <div class="flex justify-between items-center mb-4">
                        ...
                        <div class="text-sm">
                            <div class="font-medium">Thời gian còn lại:</div>
                                            ...
                                            <div class="space-y-2">
                                                <template x-for="(option, index) in currentQuestion.options" :key="option.id">
                                                    <label class="flex items-start gap-2 p-2 hover:bg-gray-50 rounded cursor-pointer">
                                                        ...
                                                        <span x-text="option.label + '. ' + option.content"></span>
                                                    </label>
                                                </template>
                                            </div>
                                        </template>
    ...
    document.addEventListener('alpine:init', () => {
        Alpine.data('readingQuiz', () => ({
            ...
            timeRemaining: {{ $quiz->duration_minutes * 60 ?? 3600 }},
