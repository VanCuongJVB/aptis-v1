                            ...
                            if ($ans && $ans->selectedOption) {
                                $selectedOptionText =
                                    ...
                                    ($ans->selectedOption->content ??
                                        ($ans->selectedOption->label ?? ($ans->selectedOption->title ?? null)));
                            }
                                ...
                                if ($selectedOption) {
                                    $selectedOptionText =
                                        ...
                                        ($selectedOption->content ??
                                            ($selectedOption->label ?? ($selectedOption->title ?? null)));
                                }
                            }
                            ...
                            $correctOptionText = $correctOption
                                ? $correctOption->text ??
                                    ($correctOption->content ??
                                        ($correctOption->label ?? ($correctOption->title ?? null)))
                                : null;
                        @endphp
                            ...
                            <div class="flex items-start justify-between">
                                <div class="font-semibold flex items-center gap-2">
                                    ...
                                    @elseif($isCorrect === false)
                                        <span
                                            class="inline-flex items-center gap-1 px-2 py-0.5 rounded bg-red-50 text-red-800 text-xs">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 20 20"
                                                fill="currentColor" aria-hidden="true">
                                                <path fill-rule="evenodd"
                            ...
                            <div class="mt-3">
                                    ...
                                    <div class="p-3 border rounded border-gray-200">
                                                ...
                                                if (is_string($ans->metadata)) {
                                                    try {
                                                        ...
                                                        if (isset($meta['selected'])) {
                                                            $userAnswers = is_array($meta['selected'])
                                                                ? $meta['selected']
                                                                : [$meta['selected']];
                                                        } elseif (isset($meta['user_answer'])) {
                                                            $userAnswers = is_array($meta['user_answer'])
                                                                ? $meta['user_answer']
                                                                : [$meta['user_answer']];
                                                        }
                                                    } catch (\Exception $e) {
                                                    ...
                                                    if (isset($ans->metadata['selected'])) {
                                                        $userAnswers = is_array($ans->metadata['selected'])
                                                            ? $ans->metadata['selected']
                                                            : [$ans->metadata['selected']];
                                                    } elseif (isset($ans->metadata['user_answer'])) {
                                                        $userAnswers = is_array($ans->metadata['user_answer'])
                                                            ? $ans->metadata['user_answer']
                                                            : [$ans->metadata['user_answer']];
                                                    }
                                                }
                                            }
                                                ...
                                                if (is_string($ans->metadata)) {
                                                    try {
                                                        ...
                                                        if (isset($meta['correct_answer'])) {
                                                            $correctAnswers = is_array($meta['correct_answer'])
                                                                ? $meta['correct_answer']
                                                                : [$meta['correct_answer']];
                                                        }
                                                    } catch (\Exception $e) {
                                                    ...
                                                    if (isset($ans->metadata['correct_answer'])) {
                                                        $correctAnswers = is_array($ans->metadata['correct_answer'])
                                                            ? $ans->metadata['correct_answer']
                                                            : [$ans->metadata['correct_answer']];
                                                    }
                                                }
                                            }
                                        ...
                                        @if (!empty($userAnswers) && !empty($correctAnswers))
                                            <div class="space-y-2">
                                                @foreach ($userAnswers as $index => $userAnswer)
                                                    ...
                                                    <div class="flex items-center space-x-4">
                                                        <div class="w-24 text-sm font-medium">Word {{ $index + 1 }}:
                                                        </div>
                                                        <div class="flex items-center">
                                                            <span
                                                                class="inline-flex items-center justify-center w-5 h-5 rounded-full {{ $isWordCorrect ? 'bg-green-500' : 'bg-red-500' }} text-white text-xs mr-2">
                                                                @if ($isWordCorrect)
                                                            ...
                                                            <span
                                                                class="font-medium {{ $isWordCorrect ? 'text-green-700' : 'text-red-700' }}">
                                                                {{ $userAnswer }}
                                                                @if (!$isWordCorrect)
                                                                    <span class="text-gray-500 ml-2">→</span>
                                                                    <span
                                                                        class="text-green-700 ml-2">{{ $correctAnswer }}</span>
                                                                @endif
                                                            </span>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="mt-3 text-sm">
                                                @php
                                                    ...
                                                    foreach ($userAnswers as $index => $userAnswer) {
                                                        if (
                                                            ...
                                                            strtolower(trim($userAnswer)) ===
                                                                strtolower(trim($correctAnswers[$index]))
                                                        ) {
                                                            $correctCount++;
                                                        }
                                                    }
                                                ...
                                                <span
                                                    class="font-medium {{ $correctCount === count($correctAnswers) ? 'text-green-700' : 'text-red-700' }}">
                                ...
                                @if (!$isCorrect && $selectedOptionText && $correctOptionText)
                                    <div class="mt-3 p-3 border border-yellow-200 rounded bg-yellow-50 text-sm">
                                        ...
                                        <p>You selected "<span class="font-medium">{{ $selectedOptionText }}</span>" but
                                            the correct answer is "<span
                                                class="font-medium">{{ $correctOptionText }}</span>".</p>
                                    </div>
                                @endif
                            </div>
                        </div>
            ...
            @if ($groupedQuestions->has(2) && $groupedQuestions[2]->count() > 0)
                <div class="mb-6" data-result-part="2">
                    ...
                    @foreach ($groupedQuestions[2] as $index => $question)
                        @php
                            // helper: decode JSON/object/array => array|null
                            $decode = function ($v) {
                                if (is_null($v) || $v === '') {
                                    return null;
                                }
                            ...
                            $meta = $decode($question->metadata) ?: [];

                            // sentences array (0-based indexed)
                            $sentences = $meta['sentences'] ?? ($meta['items'] ?? []);
                            $sentences = array_values($sentences ?: []);

                            // answer object from DB (could be null)
                            $ans = $answers->get($question->id) ?? null;
                            $ansMeta = $decode($ans->metadata ?? null);

                            // helper: find first array value by possible keys
                            $firstArrayKey = function ($arr, $keys) {
                                if (!is_array($arr)) {
                                    return null;
                                }
                                foreach ($keys as $k) {
                            ...
                            // extract raw arrays (may be indices or texts)
                            $userRaw = $firstArrayKey($ansMeta, [
                                'user_answer',
                                'selected',
                                'answers',
                                'answers_order',
                            ...
                            $correctRaw =
                                $firstArrayKey($ansMeta, ['correct_answer', 'correct', 'correct_answers']) ??
                                $firstArrayKey($meta, ['correct_order', 'correct', 'correct_answers', 'answers']);

                            // normalize a mixed array (indices or texts) -> indices (ints)
                            $toIndices = function ($arr, $sentences) {
                                $out = [];
                                if (!is_array($arr)) {
                                    return $out;
                                }
                                foreach ($arr as $v) {
                                    ...
                                    if (is_numeric($v)) {
                                        $i = (int) $v;
                                        // handle possible 1-based from FE -> try convert if out of bounds
                                        ...
                                        $trim = trim($v);
                                        // exact match
                                        $found = array_search($trim, $sentences, true);
                                        if ($found !== false) {
                                            $out[] = $found;
                                        } else {
                                            // try loose match (trim extra spaces)
                                            foreach ($sentences as $si => $text) {
                                                if (strcasecmp(trim($text), $trim) === 0) {
                                                    $out[] = $si;
                                                    break;
                                                }
                                            }
                            ...
                            // Determine display correctness (all positions match)
                            $displayCorrect = null;
                            if (
                                !empty($userIndices) &&
                                !empty($correctIndices) &&
                                count($userIndices) === count($correctIndices)
                            ) {
                                $all = true;
                                ...
                                // fallback to stored flag (if exists)
                                $displayCorrect = $ans && isset($ans->is_correct) ? $ans->is_correct : null;
                            }
                        @endphp
                            ...
                            <div class="mt-4">
                                ...
                                @else
                                    <div class="p-4 border rounded-lg bg-red-50 text-center">
                                        ...
                                        <p class="text-red-500 text-sm mt-1">You did not submit an answer for this question.
                                        </p>
                                    </div>
                                @endif
                            </div>
                                ...
                                @php
                                    ...
                                    if ($ans) {
                                        ...
                                        if (isset($ans->metadata)) {
                                            if (is_string($ans->metadata)) {
                                                try {
                                                    $ansMeta = json_decode($ans->metadata, true);
                                                    if (isset($ansMeta['user_answer'])) {
                                                        $userAnswers = is_array($ansMeta['user_answer'])
                                                            ? $ansMeta['user_answer']
                                                            : [$ansMeta['user_answer']];
                                                    } elseif (isset($ansMeta['selected'])) {
                                                        $userAnswers = is_array($ansMeta['selected'])
                                                            ? $ansMeta['selected']
                                                            : [$ansMeta['selected']];
                                                    }
                                                } catch (\Exception $e) {
                                            ...
                                            if (is_string($ans->metadata)) {
                                                try {
                                                    ...
                                                    if (isset($ansMeta['correct_answer'])) {
                                                        $correctAnswers = is_array($ansMeta['correct_answer'])
                                                            ? $ansMeta['correct_answer']
                                                            : [$ansMeta['correct_answer']];
                                                    }
                                                } catch (\Exception $e) {
                                                }
                                        ...
                                        foreach ($userAnswers as $index => $userAnswer) {
                                            if (
                                                ...
                                                (is_numeric($userAnswer) &&
                                                    is_numeric($correctAnswers[$index]) &&
                                                    intval($userAnswer) !== intval($correctAnswers[$index])) ||
                                                (is_string($userAnswer) &&
                                                    is_string($correctAnswers[$index]) &&
                                                    strtoupper(trim($userAnswer)) !==
                                                        strtoupper(trim($correctAnswers[$index])))
                                            ) {
                                                $allCorrect = false;
                                                break;
                                            }
                                        ...
                                        $isCorrect =
                                            $allCorrect &&
                                            count($userAnswers) > 0 &&
                                            count($userAnswers) === count($correctAnswers);
                                    }
                                    ...
                                    foreach ($options as $idx => $opt) {
                                        $optionTextMap[$idx] = is_array($opt)
                                            ? (isset($opt['text'])
                                                ? $opt['text']
                                                : '')
                                            : $opt;
                                                    ...
                                                    <div class="max-w-3xl mx-auto grid grid-cols-1 sm:grid-cols-2 gap-4">
                                                        @foreach (['A', 'B', 'C', 'D'] as $cat)
                                                            <div class="p-3 bg-blue-50 rounded-lg border border-blue-100">
                                                                <div class="font-medium text-blue-900 mb-1">Category
                                                                    {{ $cat }}</div>
                                                                <div class="text-sm text-blue-800">
                                                                    {{ $meta['items'][$loop->index]['text'] ?? '' }}</div>
                                                            </div>
                                                        @endforeach
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="max-w-3xl mx-auto space-y-3">
                                                        @foreach ($options as $index => $text)
                                                            @php
                                                                // Get user's answer
$selectedCategory =
    $ans->metadata['user_answer'][$index] ??
    'No Answer';
...
foreach (['A', 'B', 'C', 'D'] as $cat) {
    if (
        isset($ans->metadata['answers'][$cat]) &&
        in_array(
            $index,
            $ans->metadata['answers'][$cat],
        )
    ) {
        $correctCategory = $cat;
        break;
...
// Convert user's numeric answer to A,B,C,D
                                                                $userAnswer =
                                                                    $selectedCategory === 'No Answer'
                                                                        ? '-'
                                                                        : chr(
                                                                            65 +
                                                                                (int) $ans->metadata['user_answer'][
                                                                                    $index
                                                                                ],
                                                                        );
                                                            @endphp
                                                            ...
                                                            @php
                                                                ...
                                                                if (is_numeric($selectedCategory)) {
                                                                    $selectedCategory = chr(
                                                                        65 + intval($selectedCategory),
                                                                    );
                                                                }
                                                                ...
                                                                $isAnswerCorrect =
                                                                    ...
                                                                    strtoupper($selectedCategory) ===
                                                                        strtoupper($correctCategory);
                                                            @endphp

                                                            <div
                                                                class="flex items-center p-3 {{ $isAnswerCorrect ? 'bg-green-50 border border-green-200' : 'bg-white border border-gray-200' }} rounded-lg">
                                                                {{-- Option number and text --}}
                                                                <div class="flex-grow">
                                                                    <div class="flex items-center gap-2">
                                                                        <span
                                                                            class="font-medium {{ $isAnswerCorrect ? 'text-green-700' : 'text-gray-700' }}">{{ chr(65 + $index) }}.</span>
                                                                        <span
                                                                            class="text-gray-900">{{ $text }}</span>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="flex items-center gap-4">
                                                                    <div class="flex items-center gap-2">
                                                                        <span
                                                                            class="text-sm {{ $isAnswerCorrect ? 'text-green-600' : 'text-gray-600' }}">Your
                                                                            answer:</span>
                                                                        <span
                                                                            class="font-medium {{ $isAnswerCorrect ? 'text-green-700' : 'text-gray-700' }}">
                                                                    ...
                                                                    @if (!$isAnswerCorrect)
                                                                        <div class="flex items-center gap-2">
                                                                            <span class="text-sm text-green-600">Correct
                                                                                answer:</span>
...
if ($ans && isset($ans->metadata) && is_array($ans->metadata)) {
    if (
        isset($ans->metadata['user_answer']) &&
        is_array($ans->metadata['user_answer'])
    ) {
        $userAnswers = $ans->metadata['user_answer'];
    } elseif (
        isset($ans->metadata['selected']) &&
        is_array($ans->metadata['selected'])
    ) {
        $userAnswers = $ans->metadata['selected'];
    }
}
...
if (
    $ans &&
    isset($ans->metadata) &&
    is_array($ans->metadata) &&
    isset($ans->metadata['correct_answer'])
) {
    $correctAnswers = $ans->metadata['correct_answer'];
}
...
if ($correctAnswers === null) {
    if (isset($meta['correct']) && is_array($meta['correct'])) {
        ...
        isset($meta['correct_answers']) &&
        is_array($meta['correct_answers'])
    ) {
...
$options = $meta['options'] ?? [];
                                    ...
                                    if ($isParagraphOrdering && is_array($paragraphs) && count($paragraphs) > 0) {
                                        ...
                                        if (is_array($userAnswers) && is_array($correctAnswers)) {
                                            ...
                                            foreach ($userAnswers as $pos => $paragraphId) {
                                                if (
                                                    isset($correctAnswers[$pos]) &&
                                                    $correctAnswers[$pos] == $paragraphId
                                                ) {
                                                    $individualCorrect++;
                                                }
                                            }
                                        ...
                                        if (is_array($userAnswers) && is_array($correctAnswers)) {
                                            ...
                                            foreach ($questions as $qidx => $qtext) {
                                                ...
                                                $correctAnswer = isset($correctAnswers[$qidx])
                                                    ? $correctAnswers[$qidx]
                                                    : null;
                                                if (
                                                    $userAnswer !== null &&
                                    ...
                                    $individualPercentage =
                                        $individualTotal > 0 ? round(($individualCorrect / $individualTotal) * 100) : 0;
                                @endphp
                                                    ...
                                                    <ol class="list-decimal pl-5 space-y-3">
                                                        @foreach ($correctAnswers as $index => $paragraphId)
                                                            @php
                                                                ...
                                                                if (
                                                                    is_numeric($paragraphId) &&
                                                                    isset($paragraphs[$paragraphId])
                                                                ) {
                                                                    if (
                                                                        is_array($paragraphs[$paragraphId]) &&
                                                                        isset($paragraphs[$paragraphId]['text'])
                                                                    ) {
                                                                        $paragraphText =
...
if (strlen($paragraphText) > 120) {
    $paragraphText =
        substr($paragraphText, 0, 120) . '...';
                                                                }
                                                            @endphp
                                                            <li
                                                                class="p-3 bg-white rounded border border-green-300 shadow-sm">
                                                ...
                                                @if (is_array($userAnswers) && count($userAnswers) > 0)
                                                    ...
                                                    <div
                                                        class="p-4 border rounded {{ $isOrderingCorrect ? 'bg-green-50 border-green-200' : 'bg-red-50 border-red-200' }}">
                                                        <h4
                                                            class="font-semibold mb-3 {{ $isOrderingCorrect ? 'text-green-800' : 'text-red-800' }} flex items-center">
                                                            ...
                                                            @endif
                                                            Your Order ({{ $correctPositions }}/{{ $totalPositions }}
                                                            correct)
                                                        </h4>
                                                        <ol class="list-decimal pl-5 space-y-3">
                                                            @foreach ($userAnswers as $index => $paragraphId)
                                                                @php
                                                                    ...
                                                                    if (
                                                                        isset($correctAnswers[$index]) &&
                                                                        $correctAnswers[$index] == $paragraphId
                                                                    ) {
                                                                    ...
                                                                    if (
                                                                        ...
                                                                        if (
                                                                            ...
                                                                            is_string($paragraphs[$paragraphId])
                                                                        ) {
                                                                            $paragraphText = $paragraphs[$paragraphId];
                                                                        }
                                                                    }
...
if (strlen($paragraphText) > 120) {
    $paragraphText =
        substr($paragraphText, 0, 120) . '...';
                                                                ...
                                                                @endphp
                                                                <li
                                                                    class="p-3 rounded border shadow-sm {{ $isCorrectPosition ? 'bg-white border-green-300' : 'bg-white border-red-300' }}">
                                                                    <div class="flex items-start justify-between">
                                                                        <div
                                                                            class="text-sm text-gray-700 leading-relaxed flex-1">
                                                                            {{ $paragraphText }}</div>
                                                                        <div class="ml-2 flex-shrink-0">
                                                                            @if ($isCorrectPosition)
                                                                                <span
                                                                                    class="inline-flex items-center justify-center w-5 h-5 rounded-full bg-green-500 text-white text-xs">
                                                                                    <svg class="w-3 h-3"
                                                                                        fill="currentColor"
                                                                                        viewBox="0 0 20 20">
                                                                                        <path fill-rule="evenodd"
                                                                            ...
                                                                            @else
                                                                                <span
                                                                                    class="inline-flex items-center justify-center w-5 h-5 rounded-full bg-red-500 text-white text-xs">
                                                                                    <svg class="w-3 h-3"
                                                                                        fill="currentColor"
                                                                                        viewBox="0 0 20 20">
                                                                                        <path fill-rule="evenodd"
                                                    ...
                                                    <div class="p-4 border rounded bg-gray-50 border-gray-200">
                                                        ...
                                                        <div class="flex items-center justify-center py-8">
                                                            <div class="text-center">
                                                                ...
                                                                <p class="text-gray-500 text-sm mt-1">You did not submit an
                                    ...
                                    @elseif(is_array($questions) && count($questions) > 0)
                                        ...
                                        <div class="mt-4">
                                            <h4 class="font-semibold mb-4 text-gray-800">Reading Comprehension Questions
                                            </h4>
                                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                @foreach ($questions as $qidx => $qtext)
                                                    @php
                                                        $userAnswer =
                                                            is_array($userAnswers) && isset($userAnswers[$qidx])
                                                                ? $userAnswers[$qidx]
                                                                : null;
                                                        $correctAnswer =
                                                            is_array($correctAnswers) && isset($correctAnswers[$qidx])
                                                                ? $correctAnswers[$qidx]
                                                                : null;
                                                        $isQCorrect =
                                                            $userAnswer !== null &&
                                                    ...
                                                    <div
                                                        class="p-4 border rounded shadow-sm {{ $isQCorrect ? 'bg-green-50 border-green-200' : 'bg-red-50 border-red-200' }}">
                                                        <div class="mb-3">
                                                            <div class="flex items-center justify-between mb-2">
                                                                <span
                                                                    class="font-semibold text-sm {{ $isQCorrect ? 'text-green-800' : 'text-red-800' }}">
                                                                    Question {{ $qidx + 1 }}
                                                                </span>
                                                                <span
                                                                    class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium {{ $isQCorrect ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }}">
                                                                    @if ($isQCorrect)
                                                        ...
                                                        <div class="space-y-2">
                                                            <div class="p-2 bg-white rounded border">
                                                                <div class="text-xs font-medium text-blue-600 mb-1">Your
                                                                    Answer:</div>
                                                                <div
                                                                    class="text-sm {{ $isQCorrect ? 'text-green-700' : 'text-red-700' }} font-medium">
                    ...
                    <div class="flex justify-between mt-6">
                        <a href="{{ route('reading.full-random') }}"
                            ...
                            Again</a>
                        <a href="{{ route('student.reading.dashboard') }}"
