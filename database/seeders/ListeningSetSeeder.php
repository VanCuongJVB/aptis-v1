...
class ListeningSetSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // SET 1 (Q1-13)
        $set1Full = ReadingSet::firstOrCreate(['quiz_id' => $quizFull->id, 'title' => 'Set 1 (Q1-13)'], ['skill' => 'listening', 'description' => 'Questions 1–13', 'is_public' => true, 'order' => 1]);
        for ($i=1;$i<=13;$i++) {
        ...
        // SET 2 (Q14)
        $set2Full = ReadingSet::firstOrCreate(['quiz_id'=>$quizFull->id,'title'=>'Set 2 (Q14)'], ['skill' => 'listening', 'description'=>'Sentence completion','is_public'=>true,'order'=>2]);
        Question::create([
        ...
        // SET 3 (Q15)
        $set3Full = ReadingSet::firstOrCreate(['quiz_id'=>$quizFull->id,'title'=>'Set 3 (Q15)'], ['skill' => 'listening', 'description'=>'Who expresses which opinion','is_public'=>true,'order'=>3]);
        Question::create([
        ...
        // SET 4 (Q16–17)
        $set4Full = ReadingSet::firstOrCreate(['quiz_id'=>$quizFull->id,'title'=>'Set 4 (Q16-17)'], ['skill' => 'listening', 'description'=>'Two multiple-choice items','is_public'=>true,'order'=>4]);
            ...
            foreach ($sets as $setFull) {
                $setClone = ReadingSet::firstOrCreate(
                    ['quiz_id'=>$quizPart->id,'title'=>$setFull->title],
                        ['skill' => 'listening', 'description'=>$setFull->description,'is_public'=>true,'order'=>$setFull->order]
                );
